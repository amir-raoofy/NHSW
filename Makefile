...
obj= Main.o flowField.o FlowField.o Stencil.o StencilInvA.o Iterator.o Simulation.o zAz.o Run.o Etta.o m.o M.o Dz.o Parameters.o AI_Inv.o Solver.o jacobiSolver.o helper.o simulation.o output.o
