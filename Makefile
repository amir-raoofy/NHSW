...
test_run:
	rm -f output/*
	mpirun -n 4 ./test 10 10 6 3.5 0.01 1 0.5 10.0 10.0 12.0 10.0 9.81 0.000001787 0 0 0 0 0 > output/log

test_run_petsc:
	rm -f output/*
	mpirun -n 4 ./test_petsc 10 10 6 3.5 0.01 1 0.5 10.0 10.0 12.0 10.0 9.81 0.000001787 0 0 0 0 0 > output/log

run:
	rm -f output/*
	./nhsw 10 10 12 3.5 0.1 1 0.5 10.0 10.0 12.0 10.0 9.81 0.000001787 0 0 0 0 0 > output/log
struct:
	rm -f output/*
	./nhsw 2 2 2 3.5 0.1 1 0.5 2.0 2.0 2.0 2.0 9.81 0.000001787 0 0 0 0 0 > output/log
oscilation:
	rm -f output/*
	./nhsw 20 20 24 3.5 0.01 1 0.5 10.0 10.0 12.0 10.0 9.81 0.000001787 0 0 0 0 0 > output/log

dev: all
	rm -f output/*
	mpirun -n 1 ./test 4 4 6 3.5 0.01 1 0.5 10.0 10.0 12.0 10.0 9.81 0.000001787 0 0 0 0 0
	rm -f output/*
	mpirun -n 2 ./test 4 4 6 3.5 0.01 1 0.5 10.0 10.0 12.0 10.0 9.81 0.000001787 0 0 0 0 0
