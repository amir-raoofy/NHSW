...
obj= Main.o flowField.o FlowField.o Stencil.o Iterator.o Simulation.o Run.o Etta.o m.o M.o Dz.o Parameters.o jacobiSolver.o helper.o simulation.o output.o
