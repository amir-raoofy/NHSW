...
void Simulation::printTimeMeasurements(){
	...
	std::cout 	<< " ==============================================================="<< std::endl;
		...
		std::cout << std::left << std::setw(52) << "|Average time for one 1d solve: "					<< std::setw(11)	<< T1_/ (it0_*N) 			<< " |" << std::endl;
		...
		std::cout << std::left << std::setw(52) << "|Average time for one 2d solve: "					<< std::setw(11)	<< T2_/it0_ 				<< " |" << std::endl;
